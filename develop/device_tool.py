...
def reset_cmake_cache_if_needed(
    ...
    expected_compiler = compiler_bin_dir / ("arm-none-eabi-gcc.exe" if normalized_os_name() == "windows" else "arm-none-eabi-gcc")
    checks = {
...
def build_with_cmake(build: Dict[str, Any]) -> None:
    ...
    configure_cmd = [
        ...
        f"-DARM_GNU_TOOLCHAIN_BIN_DIR={compiler_bin_dir.as_posix()}",
