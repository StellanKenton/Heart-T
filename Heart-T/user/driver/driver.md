...
| 子目录 | 职责 | 主文档 |
| --- | --- | --- |
| `drvusb` | STM32F103 USB CDC 虚拟串口和原始字节回显 | [drvusb.md](drvusb/drvusb.md) |
...
`drvusb` → CubeMX USB PCD、STM32 HAL、ST USB Device Core/CDC；`communicationProcess` 是 USB 回显的唯一周期入口。
