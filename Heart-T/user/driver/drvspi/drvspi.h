...
* @details  : Single task owner; PA4 software CS, ADS1292R-compatible timing.
* @author   :
* @date     : 2026-09-17
* @version  : 1.0
...
/* Task context only. Call after MX_DMA_Init and MX_SPI1_Init. */
 ...
 * One task owns SPI1; callers must serialize complete device operations. */
