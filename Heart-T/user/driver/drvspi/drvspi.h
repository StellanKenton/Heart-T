/************************************************************************************
* @file     : drvspi.h
* @brief    : SPI2 blocking transaction interface.
* @details  : Single main-loop owner; PB12 software CS, ADS1292R-compatible timing.
* @author   :
* @date     : 2026-09-17
* @version  : 1.0
...
#define DRV_SPI_CS_PORT             GPIOB
#define DRV_SPI_CS_PIN              GPIO_PIN_12
#define DRV_SPI_TIMEOUT_MS          20U
#define DRV_SPI_CS_HOLD_US          10U

/* Main-loop context only. Call after MX_DMA_Init and MX_SPI2_Init. */
 ...
 * The main loop owns SPI2; callers must serialize complete device operations. */
